...
- **Base**: `master`
- **Created**: 2026-06-27
- **Status**: Ready for `/pw-continue` -- branch created, all four decisions resolved
- **GitHub Issue**: (none)
- **PR**: (planned -- one pwiz PR; ai/ changes go direct to ai master)
...
<!-- Delegation tally (fill in as you go: task -> tier -> outcome) -->
<!-- e.g. - namespace sweep -> script (Opus authored) -> clean, 0 rework -->
<!--      - rewrite osprey-development-guide prose -> Sonnet -> good, light fixups -->
<!--      - find remaining refs in ai/docs -> Haiku -> ... -->
