# TODO-20260516_ospreysharp_wsl_parity.md — Phase 1 (WSL parity, HPC chain bug hunts, C# bug ports)

> **Historical record.** This is the Phase 1 snapshot of the
> `Skyline/work/20260516_ospreysharp_wsl_parity` sprint, covering
> 2026-05-17 through 2026-05-19 afternoon. The active work has moved to
> [TODO-20260516_ospreysharp_wsl_parity.md](TODO-20260516_ospreysharp_wsl_parity.md)
> (Phase 2 — systematic cross-impl bisection).
>
> The split point is 2026-05-19 evening: Phase 1 ends after the Astral
> stage-5 perf cleanup that exposed a pre-existing Stage 5 percolator
> ULP drift; Phase 2 begins with the end-to-end Pass-1 bisection driver
> that turned that drift into the active investigation.
>
> Phase 1 is preserved for context (branch info, prior decisions,
> outstanding work items, perf measurements) but should not be edited;
> ongoing work belongs in the Phase 2 file.
