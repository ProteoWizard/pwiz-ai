    ...
    async def get_attachment(
        ...
        try:
            ...
            if "support" in container_path.lower():
                download_url = f"{_scheme()}://{server}{container_path}/announcements-download.view?entityId={parent_entity_id}&name={filename}"
            else:
                download_url = f"{_scheme()}://{server}{container_path}/wiki-download.view?entityId={parent_entity_id}&name={filename}"
