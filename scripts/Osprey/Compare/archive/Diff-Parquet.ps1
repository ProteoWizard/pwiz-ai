...
.DESCRIPTION
    ...
    Stage 6 Osprey port. The python helper is the actual
    ...
    Reused for the Rust v Osprey Stage 6 cross-impl gate.
...
param(
    ...
    # that the rest of the Osprey parity tooling uses, so Stage 1-4
