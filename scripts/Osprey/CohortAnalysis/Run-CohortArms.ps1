...
param(
    ...
    [string]$TagPrefix = 'f',
    [string]$RunsDir = 'D:\test\osprey-runs\sea-ad\runs',
    [string]$LinkFrom = 'D:/test/osprey-runs/sea-ad/runs/pass2ab-82file-percolator-5day',
    [string]$DataDir = 'D:/test/osprey-runs/sea-ad/mzml',
    [string]$LibraryDir = 'D:/test/osprey-runs/sea-ad/lib',
    [string]$Exe,
