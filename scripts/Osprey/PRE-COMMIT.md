...
pwsh -File ./pwiz_tools/Osprey/regression.ps1 -Dataset All
```
...
`pwiz_tools/Osprey/Regression/README.md`.
...
pwsh -File ./ai/scripts/Osprey/Test-Full-Regression.ps1 -Quick
```

## Cross-impl Regression (rare; for ports of Rust algorithm changes)

Only relevant when you also need to confirm Osprey hasn't
...
```powershell
pwsh -File ./ai/scripts/Osprey/Build-Osprey.ps1 -Configuration Release -RunInspection
```
...
- [Build-Osprey.ps1](Build-Osprey.ps1) -- the validation script
