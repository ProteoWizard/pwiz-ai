...
**For pwiz repository:**
- **master** - Stable releases. Run `/code-review <level>` on the branch
  BEFORE opening the PR, and clear TeamCity before requesting human review
  (Copilot auto-reviews on open) — see
